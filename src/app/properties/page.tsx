      ...
      <div className="bg-white rounded-xl border border-slate-200 shadow-sm overflow-hidden">
        {!properties.length ? (
          <div className="p-12 text-center">
            ...
            <p className="text-slate-500 mb-2">Nenhum local cadastrado.</p>
            ...
            <table className="w-full text-sm">
              <thead>
                <tr className="bg-slate-50 border-b border-slate-200 text-left">
                  ...
                  <th className="px-4 py-3 font-medium text-slate-600">Endereço</th>
                  <th className="px-4 py-3 font-medium text-slate-600 text-right">Valor normal</th>
                  <th className="px-4 py-3 font-medium text-slate-600 text-right">Valor extra</th>
